...
<?php
   ...
   echo "<input class=\"button\" type=\"submit\" value=\"Change Owner\"></input>";
   echo "</td>";
   echo "</tr>";
   echo "</table>";
   echo "</form>";
...
<?php
   ...
   echo "<input class=\"button\" type=\"submit\" value=\"Add Division\"></input>";
   echo "</td>";
   echo "</tr>";
   echo "</table>";
   echo "</form>";
   ...
   for($i=0; $i<$num_rows; $i++)
   {
      ...
      else
      {
          ...
          echo "<input class=\"button\" type=\"submit\" value=\"Change Captain\"></input>";
          echo "</td>";
          echo "</tr>";
          echo "</table>";
          echo "</form>";
          ...
          echo "<tr>";
          echo "<td colspan=\"4\">";
          echo "<input class=\"button\" type=\"submit\" name=\"kick\" value=\"Kick Selected\"></input>";
          echo "</td>\n";
          echo "</tr>";
          echo "</table>\n";
          echo "</form>";
