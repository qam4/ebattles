...
define("TBL_EVENTS",          $eb.MPREFIX.TBL_EVENTS_SHORT);
define("TBL_EVENTMODS",       $eb.MPREFIX.TBL_EVENTMODS_SHORT);
define("TBL_TEAMS",           $eb.MPREFIX.TBL_TEAMS_SHORT);
define("TBL_MATCHS",          $eb.MPREFIX.TBL_MATCHS_SHORT);
define("TBL_PLAYERS",         $eb.MPREFIX.TBL_PLAYERS_SHORT);
define("TBL_SCORES",          $eb.MPREFIX.TBL_SCORES_SHORT);
define("TBL_CLANS",           $eb.MPREFIX.TBL_CLANS_SHORT);
define("TBL_DIVISIONS",       $eb.MPREFIX.TBL_DIVISIONS_SHORT);
define("TBL_MEMBERS",         $eb.MPREFIX.TBL_MEMBERS_SHORT);
define("TBL_STATSCATEGORIES", $eb.MPREFIX.TBL_STATSCATEGORIES_SHORT);
define("TBL_GAMES",           $eb.MPREFIX.TBL_GAMES_SHORT);
define("TBL_AWARDS",          $eb.MPREFIX.TBL_AWARDS_SHORT);
define("TBL_PLAYERS_RESULTS", $eb.MPREFIX.TBL_PLAYERS_RESULTS_SHORT);
define("TBL_GAMES_GENRES",    $eb.MPREFIX.TBL_GAMES_GENRES_SHORT);
define("TBL_GAMES_PLATFORMS", $eb.MPREFIX.TBL_GAMES_PLATFORMS_SHORT);
