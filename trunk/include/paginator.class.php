...
class Paginator{
	...
	function display_items_per_page()
	{
		...
		return "<span class=\"paginate\">Items per page </span><select class=\"tbox\" onchange=\"window.location='$_SERVER[PHP_SELF]?page=1&ipp='+this[this.selectedIndex].value+'$this->querystring';return false\">$items</select>\n";
	}
	...
	function display_jump_menu()
	{
		...
		return "<span class=\"paginate\">Page </span><select class=\"tbox\" onchange=\"window.location='$_SERVER[PHP_SELF]?page='+this[this.selectedIndex].value+'&ipp=$this->items_per_page$this->querystring';return false\">$option</select>\n";
	}
