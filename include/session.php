...
class Session
{
   ...
   var $timezone_offset;     //Last recorded site page viewed
   ...
   function startSession(){
      ...
      /*fm - debug_var('Test debug: ',$this->logged_in);*/
   ...
   function checkLogin(){
      ...
      if(isset($_COOKIE['cookname']) && isset($_COOKIE['cookid']) && isset($_COOKIE['cooktzo'])){
         ...
         $this->timezone_offset = $_SESSION['timezone_offset']   = $_COOKIE['cooktzo'];
      }
      ...
      if(isset($_SESSION['username']) && isset($_SESSION['userid']) &&
         ...
         if($sql->confirmUserID($_SESSION['username'], $_SESSION['userid']) != 0){
            ...
            unset($_SESSION['timezone_offset']);
            return false;
         }
   ...
   function login($subuser, $subpass, $subtzo, $subremember){
       ...
       */
      if($subremember){
         setcookie("cookname", $this->username, GMT_time()+COOKIE_EXPIRE, COOKIE_PATH);
         setcookie("cookid",   $this->userid,   GMT_time()+COOKIE_EXPIRE, COOKIE_PATH);
         setcookie("cooktzo",  $this->timezone_offset,   GMT_time()+COOKIE_EXPIRE, COOKIE_PATH);
      }
   ...
   function logout(){
       ...
       */
      if(isset($_COOKIE['cookname']) && isset($_COOKIE['cookid'])  && isset($_COOKIE['cooktzo'])){
         setcookie("cookname", "", GMT_time()-COOKIE_EXPIRE, COOKIE_PATH);
         setcookie("cookid",   "", GMT_time()-COOKIE_EXPIRE, COOKIE_PATH);
         setcookie("cooktzo",  "", GMT_time()-COOKIE_EXPIRE, COOKIE_PATH);
      }
