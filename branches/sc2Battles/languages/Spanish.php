...
define('EB_ADMIN_L3', 'Retraso de las atualizaciones de los Ladderos');
define('EB_ADMIN_L4', 'Si esta activado, los ladderos se volvera a calcular las estadisticas solo si el laddero ha cambiado y el retraso ha expirado');
...
define('EB_ADMIN_L12', 'Creadores de Ladderos userclass');
...
define('EB_ADMIN_L46', 'Mostrar bot�n de creaci�n de ladderos');
...
define('EB_LADDERS_L1', 'Ladderos');
define('EB_LADDERS_L2', 'Ladderos Atuales');
define('EB_LADDERS_L3', 'Ladderos Recientes');
define('EB_LADDERS_L4', 'Ultimo');
define('EB_LADDERS_L5', 'Nombre');
define('EB_LADDERS_L6', 'Juego');
define('EB_LADDERS_L7', 'Tipo');
define('EB_LADDERS_L8', 'Fecha de inicio');
define('EB_LADDERS_L9', 'Juegos:');
define('EB_LADDERS_L10', 'Todos');
define('EB_LADDERS_L11', 'Erro en la muestra de los ladderos');
define('EB_LADDERS_L12', 'Sin Ladderos');
define('EB_LADDERS_L13', 'Laddero');
define('EB_LADDERS_L14', 'Juego');
define('EB_LADDERS_L15', 'Tipo');
define('EB_LADDERS_L16', 'Inicio');
define('EB_LADDERS_L17', 'Fin');
define('EB_LADDERS_L18', 'Equipos/Jugadores');
define('EB_LADDERS_L19', 'Juegos');
define('EB_LADDERS_L20', 'Crear nuevo Laddero');
define('EB_LADDERS_L21', 'Mostrar todos los ladderos pasados');
define('EB_LADDERS_L22', 'Liga Individual');
define('EB_LADDERS_L23', 'Liga Individual por Equipos');
define('EB_LADDERS_L24', 'Filtro');
define('EB_LADDERS_L25', 'Liga por Equipos');
define('EB_LADDERS_L26', 'Hola ');
define('EB_LADDERS_L27', ',
	Usted esta invitado a participar en la laddero "');
define('EB_LADDERS_L29', '"
	Por favor revise su "Mi prefil/Ladderos" pagina para ver los detalles laddero.');
define('EB_LADDERS_L30', '"
	Por favor, haga clic en el siguiente enlace para ver los detalles laddero: ');
define('EB_LADDERS_L31', '
	Cordialmente,
	El laddero admin ');

define('EB_LADDER_L1', 'Ladderos');
define('EB_LADDER_L2', 'Comienza en');
define('EB_LADDER_L3', 'Termina en');
define('EB_LADDER_L4', 'Laddero esta terminado');
define('EB_LADDER_L5', 'Laddero');
define('EB_LADDER_L6', 'Registro');
define('EB_LADDER_L7', 'Usted es el capitan de');
define('EB_LADDER_L8', 'Introduzca la contrase&ntilde;a y haga clic aqui para que su equipo de participar en este laddero.');
define('EB_LADDER_L9', 'Introduzca la contrase&ntilde;a');
define('EB_LADDER_L10', 'Registrate en este equipo!');
define('EB_LADDER_L11', 'Haga clic aqui para poner su equipo a participar en este laddero.');
define('EB_LADDER_L12', 'Registrate en este equipo!');
define('EB_LADDER_L13', 'Este equipo ya esta registrado.');
define('EB_LADDER_L14', 'Usted no es miembro de cualquier equipo o mismo para este juego.');
define('EB_LADDER_L15', 'Tus Equipos');
define('EB_LADDER_L16', 'No esta registrado en este laddero.');
define('EB_LADDER_L17', 'Pongase en contacto con su capitan');
define('EB_LADDER_L18', 'se ha apuntado para este laddero.');
define('EB_LADDER_L19', 'Registro!');
define('EB_LADDER_L20', 'Actualmente usted esta prohibido en este laddero.');
define('EB_LADDER_L21', 'Pongase en contacto con los moderadores de ladderos para mas informacion.');
define('EB_LADDER_L22', 'Usted ya esta registrado.');
define('EB_LADDER_L23', 'Salga deste laddero');
define('EB_LADDER_L24', '&iquest;Estas seguro de que desea cerrar este laddero?');
define('EB_LADDER_L25', 'Introduzca la contrase&ntilde;a y haga click aqui para participar a este laddero.');
define('EB_LADDER_L26', 'Contrase&ntilde;a del Laddero');
define('EB_LADDER_L27', 'Introduzca la contrase&ntilde;a');
define('EB_LADDER_L28', 'Haga clic aqui para participar a este laddero.');
define('EB_LADDER_L29', 'En este momento estas prohibido para este laddero.');
define('EB_LADDER_L30', 'Pongase en contacto con los mods de ladderos para mas informacion.');
define('EB_LADDER_L31', 'Usted ya esta registrado.');
define('EB_LADDER_L32', 'Salga de este laddero');
define('EB_LADDER_L33', '&iquest;Estas seguro de que desea cerrar este laddero?');
define('EB_LADDER_L34', 'Inicia sesiin para participar en este laddero.');
define('EB_LADDER_L35', 'Info');
define('EB_LADDER_L36', 'Laddero');
define('EB_LADDER_L37', 'Tipo');
define('EB_LADDER_L38', 'Juego');
define('EB_LADDER_L39', 'Administrador');
define('EB_LADDER_L40', 'Haga clic aqui para administrar este laddero');
define('EB_LADDER_L41', 'Moderatore(s)');
define('EB_LADDER_L42', 'Inicio');
define('EB_LADDER_L43', 'Final');
define('EB_LADDER_L44', 'Reglas');
define('EB_LADDER_L45', 'Clasificaciones');
define('EB_LADDER_L46', 'Proxima Actualizacion:');
define('EB_LADDER_L47', 'Minimo');
define('EB_LADDER_L48', 'Clasificar de los equipos por rangos.');
define('EB_LADDER_L49', 'Clasificacion de Jugadores');
define('EB_LADDER_L50', 'Proxima Actualizacion:');
define('EB_LADDER_L51', 'Jugadores');
define('EB_LADDER_L52', 'Minimo');
define('EB_LADDER_L53', 'los partidos para clasificar.');
define('EB_LADDER_L54', 'Sin Clasificar');
define('EB_LADDER_L55', 'Mostrar mi posicion');
define('EB_LADDER_L56', 'Informe de Perdidas ');
define('EB_LADDER_L57', 'Informe del partido');
define('EB_LADDER_L58', 'Ultimos Partidos');
define('EB_LADDER_L59', 'Partidos jugados');
define('EB_LADDER_L60', 'Mostrar todos los partidos');
define('EB_LADDER_L61', 'Partido');
define('EB_LADDER_L62', 'Ver detalles');
define('EB_LADDER_L63', 'Ultimos Premios');
define('EB_LADDER_L64', 'Partido(s) pendiente');
define('EB_LADDER_L65', 'Desaf�o de un jugador');
define('EB_LADDER_L66', 'desaf�o(s) solicitada');
define('EB_LADDER_L67', 'desaf�o(s) sin confirmar');
define('EB_LADDER_L68', 'desaf�o(s) pendiente');
define('EB_LADDER_L69', 'Desaf�o eliminado');
define('EB_LADDER_L70', 'partido(s) solicitada');
define('EB_LADDER_L71', 'Desaf�o de un Equipo');
define('EB_LADDER_L72', 'Horario de un partido');
define('EB_LADDER_L73', 'partido(s) para aprobar');

define('EB_LADDERM_L1', 'Gestionar - LADDERO');
define('EB_LADDERM_L2', 'Resumen');
define('EB_LADDERM_L3', 'Configuracion');
define('EB_LADDERM_L4', 'Reglas');
define('EB_LADDERM_L5', 'Jugadores/Equipos');
define('EB_LADDERM_L6', 'Reiniciar');
define('EB_LADDERM_L7', 'Estadisticas');
define('EB_LADDERM_L8', 'Laddero');
define('EB_LADDERM_L9', 'Administrador');
define('EB_LADDERM_L10', 'Cambiar Administrador');
define('EB_LADDERM_L11', 'Moderadores');
define('EB_LADDERM_L12', 'Eliminar Moderador');
define('EB_LADDERM_L13', '&iquest;Estas seguro de que deseas eliminar este moderador?');
define('EB_LADDERM_L14', 'Agregar Moderador');
define('EB_LADDERM_L15', 'Nombre');
define('EB_LADDERM_L16', 'Ingreso al laddero con Contrase&ntilde;a');
define('EB_LADDERM_L17', 'Juego');
define('EB_LADDERM_L18', 'tipo');
define('EB_LADDERM_L19', 'Individual');
define('EB_LADDERM_L20', 'Equipo/Individual');
define('EB_LADDERM_L21', 'Partido report userclass');
define('EB_LADDERM_L22', 'Jugador del Laddero');
define('EB_LADDERM_L23', 'Moderador del Laddero');
define('EB_LADDERM_L24', 'Administrador del Laddero');
define('EB_LADDERM_L25', 'Permitir Derota rapida');
define('EB_LADDERM_L26', 'Permitir Puntacion');
define('EB_LADDERM_L27', 'Permitir Empates');
define('EB_LADDERM_L28', 'Puntos');
define('EB_LADDERM_L29', 'por victoria');
define('EB_LADDERM_L30', 'Por empate');
define('EB_LADDERM_L31', 'por derota');
define('EB_LADDERM_L32', 'Fecha de inicio');
define('EB_LADDERM_L33', 'Selector de fecha');
define('EB_LADDERM_L34', 'Reinicializar');
define('EB_LADDERM_L35', 'Fecha de finalizacion');
define('EB_LADDERM_L36', 'Descricion');
define('EB_LADDERM_L37', 'Guardar configuracion');
define('EB_LADDERM_L38', 'Reglas');
define('EB_LADDERM_L39', 'Guardar Reglas');
define('EB_LADDERM_L40', 'Jugadores');
define('EB_LADDERM_L41', 'A&ntilde;adir a un equipo');
define('EB_LADDERM_L42', 'A&ntilde;adir Equipo');
define('EB_LADDERM_L43', 'Notificar al capitan del equipo por PM.');
define('EB_LADDERM_L44', 'A&ntilde;adir un Jugador');
define('EB_LADDERM_L45', 'A&ntilde;adir Jugador');
define('EB_LADDERM_L46', 'Notificar al usuario por PM.');
define('EB_LADDERM_L47', 'Explusar');
define('EB_LADDERM_L48', 'Usted puede patear (eliminar) un jugador que no tiene juegos jugados y no los premios.<br />
Un jugador expulsado puede volver a registrarse para el laddero.');
define('EB_LADDERM_L49', 'Banir');
define('EB_LADDERM_L50', 'Usted puede banir/desbanir un jugador temporariamiente.<br />
Un jugador banido ya no puede jugar en el laddero o registrarse para el mismo laddero mientras este banido.');
define('EB_LADDERM_L51', 'Informacion de erros');
define('EB_LADDERM_L52', 'Sin Jugadores');
define('EB_LADDERM_L53', 'Sin Puesto');
define('EB_LADDERM_L54', 'Banido');
define('EB_LADDERM_L55', 'Nombre');
define('EB_LADDERM_L56', 'Rank');
define('EB_LADDERM_L57', 'Juegos');
define('EB_LADDERM_L58', 'Premios');
define('EB_LADDERM_L59', 'Acciones');
define('EB_LADDERM_L60', 'Desbanir Jugador');
define('EB_LADDERM_L61', '&iquest;Estas seguro de que deseas desbanir este jugador?');
define('EB_LADDERM_L62', 'Banir Jugador');
define('EB_LADDERM_L63', '&iquest;Estas seguro de que deseas banir este jugador?');
define('EB_LADDERM_L64', 'Echar Jugador');
define('EB_LADDERM_L65', '&iquest;Estas seguro de que deseas expulsar este jugador?');
define('EB_LADDERM_L66', 'Eliminar juegos del jugador');
define('EB_LADDERM_L67', '&iquest;Estas seguro de que deseas eliminar los juegos deste jugador?');
define('EB_LADDERM_L68', 'Eliminar lo premios del jugador');
define('EB_LADDERM_L69', '&iquest;Estas seguro de que deseas eliminar los premios deste jugador?');
define('EB_LADDERM_L70', 'Reiniciar Jugadores/Equipos.');
define('EB_LADDERM_L71', '- Reiniciar Jugadores y Equipos Estadisticas (Ranking, Resultados, ELO, Experiencia, Partidos Jugados, Vitorias, Derotas)<br />- Eliminar todos los partidos');
define('EB_LADDERM_L72', 'Reiniciar Puntuaciones');
define('EB_LADDERM_L73', '&iquest;Estas seguro de que deseas eliminar lo resultados deste laddero?');
define('EB_LADDERM_L74', 'Riniciar Laddero.');
define('EB_LADDERM_L75', '- Borrar todos los jugadores y los equipos.<br />- Eliminar todos los partidos.');
define('EB_LADDERM_L76', 'Reiniciar Laddero');
define('EB_LADDERM_L77', '&iquest;Estas seguro de que deseas reiniciar este laddero?');
define('EB_LADDERM_L78', 'Eliminar Laddero.');
define('EB_LADDERM_L79', '- Elimina Laddero.<br />');
define('EB_LADDERM_L80', 'Borrar Laddero');
define('EB_LADDERM_L81', '&iquest;Estas seguro de que deseas borrar este laddero?');
define('EB_LADDERM_L82', 'Recalcular las Estadisticas del Laddero.');
define('EB_LADDERM_L83', '- Reiniciar y volver a calcular estadisticas de los jugadores.<br />');
define('EB_LADDERM_L84', 'Recalcular la Estadisticas del Laddero');
define('EB_LADDERM_L85', '&iquest;Estas seguro de que deseas volver a calcular todas las puntuaciones?');
define('EB_LADDERM_L86', 'Introduzca los valores de estadisticas maximos para cada categoria.<br />Las Categorias se muestran en orden de numero de maximo.<br />Categorias con Max = 0 no se mostraran.<br />');
define('EB_LADDERM_L87', 'Estatus');
define('EB_LADDERM_L88', 'Max');
define('EB_LADDERM_L89', 'Solo Inf.');
define('EB_LADDERM_L90', 'Numero de partidos para Ranking');
define('EB_LADDERM_L91', 'Numero de partidos del equipo para Ranking');
define('EB_LADDERM_L92', 'ELO');
define('EB_LADDERM_L93', 'Partidos Jugados');
define('EB_LADDERM_L94', 'Vence/Perde');
define('EB_LADDERM_L95', 'Percentagen de victorias');
define('EB_LADDERM_L96', 'Vence/Empate/Perde');
define('EB_LADDERM_L97', 'Rivales unicos');
define('EB_LADDERM_L98', 'Sistema ELO; Promedio entre Rivales');
define('EB_LADDERM_L99', 'Rachas');
define('EB_LADDERM_L100', 'Experiencias');
define('EB_LADDERM_L101', 'Resultados');
define('EB_LADDERM_L102', 'Puntuacion Rival');
define('EB_LADDERM_L103', 'Diferencia de Puntuaciones');
define('EB_LADDERM_L104', 'Puntos');
define('EB_LADDERM_L105', 'Puntuacion Max');
define('EB_LADDERM_L106', 'Esconder columna de puntuaciones en caso de control');
define('EB_LADDERM_L107', 'Guardar Estadisticas');
define('EB_LADDERM_L108', 'Aprobacion del partido');
define('EB_LADDERM_L109', 'Solo los miembros de la clase seleccionada pueden aprobar los partidos.');
define('EB_LADDERM_L110', 'Administracion del Laddero');
define('EB_LADDERM_L111', 'Moderador del Laddero');
define('EB_LADDERM_L112', 'Informacion del Partido Rival');
define('EB_LADDERM_L113', 'Desactivar');
define('EB_LADDERM_L114', 'Equipo(s)');
define('EB_LADDERM_L115', 'Sin Equipos');
define('EB_LADDERM_L116', 'Equipo');
...
define('EB_LADDERM_L121', 'Laddero Desaf�os');
define('EB_LADDERM_L122', 'Activar/Desactivar Desaf�os');
define('EB_LADDERM_L123', 'Guardar configuracion de los desaf�os');
define('EB_LADDERM_L124', 'Numero maximo de fechas por Desafio');
define('EB_LADDERM_L125', 'Numero maximo de mapas por partido');

define('EB_LADDERP_L1', 'Ladderos anteriores');
define('EB_LADDERP_L2', 'Ladderos anteriores');
define('EB_LADDERP_L3', 'Volver a');
define('EB_LADDERP_L4', 'Ladderos');

define('EB_LADDERC_L1', 'Crear laddero');
define('EB_LADDERC_L2', 'Usted no esta autorizado para crear un laddero.');
define('EB_LADDERC_L3', 'Laddero');
define('EB_LADDERC_L4', 'Ponga una descripcion de su laddero aqui');
...
define('EB_CLAN_L19', 'Sin ladderos');
define('EB_CLAN_L20', 'ladderos atuale(s)');
define('EB_CLAN_L21', 'Laddero');
define('EB_CLAN_L22', 'Rango');
define('EB_CLAN_L23', 'No ay ladderos anteriores');
define('EB_CLAN_L24', 'ladderos(s) anteriores');
...
define('EB_MATCHR_L47', 'Se recomienda actualizar las estad�sticas de ladderos despu�s de edici�n de partido.');
...
define('EB_MATCHR_L55', ' en el laddero "');
...
define('EB_CHALLENGE_L4', 'Laddero:');
...
define('EB_CHALLENGE_L14', 'Ladderos');
...
define('EB_CHALLENGE_L26', ' en el laddero "');
...
define('EB_CHALLENGE_L32', ' en el laddero "');
...
define('EB_USER_L9', 'Juega en los siguientes ladderos');
...
define('EB_USER_L19', 'es Administrador de los siguientes ladderos');
define('EB_USER_L20', 'Moderador');
define('EB_USER_L21', 'es Moderador en los siguientes ladderos');
