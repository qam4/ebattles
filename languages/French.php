...
define('EB_LADDERS_L1', 'Tournois');
define('EB_LADDERS_L2', 'Tournois en cours');
define('EB_LADDERS_L3', 'Tournois Récents');
define('EB_LADDERS_L4', 'Plus récent');
define('EB_LADDERS_L5', 'Nom');
define('EB_LADDERS_L6', 'Jeu');
define('EB_LADDERS_L7', 'Type');
define('EB_LADDERS_L8', 'Date de début');
define('EB_LADDERS_L9', 'Jeux:');
define('EB_LADDERS_L10', 'Tous');
define('EB_LADDERS_L11', 'Erreur lors de l’affichage des tournois');
define('EB_LADDERS_L12', 'Pas de Tournois');
define('EB_LADDERS_L13', 'Tournoi');
define('EB_LADDERS_L14', 'Jeu');
define('EB_LADDERS_L15', 'Type');
define('EB_LADDERS_L16', 'Début');
define('EB_LADDERS_L17', 'Fin');
define('EB_LADDERS_L18', 'Équipes/Joueurs');
define('EB_LADDERS_L19', 'Matchs');
define('EB_LADDERS_L20', 'Créer un nouveau tournoi');
define('EB_LADDERS_L21', 'Afficher tous les tournois passés');
define('EB_LADDERS_L22', 'Tournoi individuel');
define('EB_LADDERS_L23', 'Tournoi individuel par équipe');
define('EB_LADDERS_L24', 'Filtrer');
define('EB_LADDERS_L25', 'Tournoi par équipe');
define('EB_LADDERS_L26', 'Bonjour ');
...
define('EB_LADDER_L1', 'Tournois');
define('EB_LADDER_L2', 'Le tournoi débute dans');
define('EB_LADDER_L3', 'Le tournoi se termine dans');
define('EB_LADDER_L4', 'Le tournoi est terminé');
define('EB_LADDER_L5', 'Tournoi');
define('EB_LADDER_L6', 'Inscription');
define('EB_LADDER_L7', 'Vous êtes le capitaine de');
define('EB_LADDER_L8', 'Entrez le mot de passe et clickez ici pour faire participer votre équipe à ce tournoi.');
define('EB_LADDER_L9', 'Entrez le mot de passe');
define('EB_LADDER_L10', 'Inscrire cette équipe!');
define('EB_LADDER_L11', 'Cliquez ici pour faire participer votre équipe à ce tournoi.');
define('EB_LADDER_L12', 'Inscrire cette équipe!');
define('EB_LADDER_L13', 'Cette équipe est inscrite à ce tournoi.');
define('EB_LADDER_L14', 'Vous n’êtes membre d’aucune équipe qui participe à ce tournoi.');
define('EB_LADDER_L15', 'Votre équipe');
define('EB_LADDER_L16', 'n’est pas inscrite à ce tournoi.');
define('EB_LADDER_L17', 'Veuillez contacter vote capitaine');
define('EB_LADDER_L18', 'est inscrite à ce tournoi.');
define('EB_LADDER_L19', 'Inscrivez-vous!');
define('EB_LADDER_L20', 'Vous êtes bani de ce tournoi.');
define('EB_LADDER_L21', 'Veuillez contacter les moderateurs de ce tournoi pour plus d’informations.');
define('EB_LADDER_L22', 'Vous êtes inscrit à ce tournoi.');
define('EB_LADDER_L23', 'Quitter ce tournoi');
define('EB_LADDER_L24', 'Êtes-vous sure de vouloir quitter ce tournoi?');
define('EB_LADDER_L25', 'Entrez le mot de passe et clickez ici pour participer à ce tournoi');
define('EB_LADDER_L26', 'Mot de passe du tournoi');
define('EB_LADDER_L27', 'Entrez le mot de passe');
define('EB_LADDER_L28', 'Clickez ici pour participer à ce tournoi.');
define('EB_LADDER_L29', 'Vous êtes bani de ce tournoi.');
define('EB_LADDER_L30', 'Veuillez contacter les moderateurs de ce tournoi pour plus d’informations.');
define('EB_LADDER_L31', 'Vous êtes inscrit à ce tournoi.');
define('EB_LADDER_L32', 'Quittez ce tournoi');
define('EB_LADDER_L33', 'Êtes-vous sure de vouloir quitter ce tournoi?');
define('EB_LADDER_L34', 'Veuillez-vous connecter au site pour participer à ce tournoi.');
define('EB_LADDER_L35', 'Info et Règlement');
define('EB_LADDER_L36', 'Tournoi');
define('EB_LADDER_L37', 'Type');
define('EB_LADDER_L38', 'Jeu');
define('EB_LADDER_L39', 'Responsable');
define('EB_LADDER_L40', 'Cliquez ici pour gérer ce tournoi');
define('EB_LADDER_L41', 'Moderateur(s)');
define('EB_LADDER_L42', 'Début');
define('EB_LADDER_L43', 'Fin');
define('EB_LADDER_L44', 'Règles');
define('EB_LADDER_L45', 'Classement des équipes');
define('EB_LADDER_L46', 'Prochaine mise à jour:');
define('EB_LADDER_L47', 'Minimum');
define('EB_LADDER_L48', 'match(s) d’équipe pour être classé.');
define('EB_LADDER_L49', 'Classements des joueurs');
define('EB_LADDER_L50', 'Prochaine mise à jour:');
define('EB_LADDER_L51', 'joueurs');
define('EB_LADDER_L52', 'Minimum');
define('EB_LADDER_L53', 'match(s) pour être classé.');
define('EB_LADDER_L54', 'Non classé');
define('EB_LADDER_L55', 'Ma Position');
define('EB_LADDER_L56', 'Rapport rapide de défaite');
define('EB_LADDER_L57', 'Rapport de match');
define('EB_LADDER_L58', 'Matchs');
define('EB_LADDER_L59', 'match(s) joué(s)');
define('EB_LADDER_L60', 'Afficher tous les Matchs');
define('EB_LADDER_L61', 'Match');
define('EB_LADDER_L62', 'Voir les détails');
define('EB_LADDER_L63', 'Trophés récents');
define('EB_LADDER_L64', 'match(s) en attente');
define('EB_LADDER_L65', 'Défier ce joueur');
define('EB_LADDER_L66', 'Défi(s) lancés');
define('EB_LADDER_L67', 'Défi(s) non-confirmé(s)');
define('EB_LADDER_L68', 'Défi(s) en attente');
define('EB_LADDER_L69', 'Défi effacé');
define('EB_LADDER_L70', 'match(s) prévu(s)');
define('EB_LADDER_L71', 'Défier cette équipe');
define('EB_LADDER_L72', 'Planifier un match');
define('EB_LADDER_L73', 'match(s) à approuver');

define('EB_LADDERM_L1', 'Gérer');
define('EB_LADDERM_L2', 'Sommaire');
define('EB_LADDERM_L3', 'Paramètres');
define('EB_LADDERM_L4', 'Règles');
define('EB_LADDERM_L5', 'Joueurs/Équipes');
define('EB_LADDERM_L6', 'Réinitialiser');
define('EB_LADDERM_L7', 'Statistiques');
define('EB_LADDERM_L8', 'Tournoi');
define('EB_LADDERM_L9', 'Admin');
define('EB_LADDERM_L10', 'Changer l’Admin');
define('EB_LADDERM_L11', 'Moderateurs');
define('EB_LADDERM_L12', 'Enlever ce Modérateur');
define('EB_LADDERM_L13', 'Êtes-vous sûr de vouloir supprimer ce modérateur?');
define('EB_LADDERM_L14', 'Ajouter un Modérateur');
define('EB_LADDERM_L15', 'Nom');
define('EB_LADDERM_L16', 'Mot de passe');
define('EB_LADDERM_L17', 'Jeu');
define('EB_LADDERM_L18', 'Type');
define('EB_LADDERM_L19', 'Individuel');
define('EB_LADDERM_L20', 'Individuel par équipe');
define('EB_LADDERM_L21', 'Groupe d’utilisateurs authorisés à saisir un match');
define('EB_LADDERM_L22', 'Joueur du tournoi');
define('EB_LADDERM_L23', 'Moderateur du tournoi');
define('EB_LADDERM_L24', 'Admin du tournoi');
define('EB_LADDERM_L25', 'Permettre le rapport Rapide de Défaite');
define('EB_LADDERM_L26', 'Permettre la saisie du Score');
define('EB_LADDERM_L27', 'Permettre les matchs nuls');
define('EB_LADDERM_L28', 'Points');
define('EB_LADDERM_L29', 'par victoire');
define('EB_LADDERM_L30', 'par match nul');
define('EB_LADDERM_L31', 'par défaite');
define('EB_LADDERM_L32', 'Date de début');
define('EB_LADDERM_L33', 'Sélecteur de Date');
define('EB_LADDERM_L34', 'Réinitialiser');
define('EB_LADDERM_L35', 'Date de fin');
define('EB_LADDERM_L36', 'Description');
define('EB_LADDERM_L37', 'Sauver les Paramètres');
define('EB_LADDERM_L38', 'Règles');
define('EB_LADDERM_L39', 'Sauver les Règles');
define('EB_LADDERM_L40', 'joueur(s)');
define('EB_LADDERM_L41', 'Ajouter une Équipe');
define('EB_LADDERM_L42', 'Ajouter l’Équipe');
define('EB_LADDERM_L43', 'Aviser les joueurs de l’équipe par PM.');
define('EB_LADDERM_L44', 'Ajouter un Joueur');
define('EB_LADDERM_L45', 'Ajouter le Joueur');
define('EB_LADDERM_L46', 'Aviser le joueur de l’équipe par PM.');
define('EB_LADDERM_L47', 'Kick');
define('EB_LADDERM_L48', 'Vous pouvez "kicker" (supprimer) un joueur qui n’a pas de matchs joués ou de trophés<br />
Un joueur "kické" peut se re-inscrire au tournoi.');
define('EB_LADDERM_L49', 'Exclure');
define('EB_LADDERM_L50', 'Vous pouvez temporairement bannir/débannir un joueur.<br />
Un joueur banni ne peut plus jouer dans le tournoi ou s’inscrire au tournoi pendant la durée de l’exclusion.');
define('EB_LADDERM_L51', 'Erreur lors de l’affichage des joeurs');
define('EB_LADDERM_L52', 'Pas de Joueurs');
define('EB_LADDERM_L53', 'Non Classé');
define('EB_LADDERM_L54', 'Banni');
define('EB_LADDERM_L55', 'Nom');
define('EB_LADDERM_L56', 'Classement');
define('EB_LADDERM_L57', 'Matchs');
define('EB_LADDERM_L58', 'Trophés');
define('EB_LADDERM_L59', 'Actions');
define('EB_LADDERM_L60', 'Dé-bannir le Joueur');
define('EB_LADDERM_L61', 'Êtes-vous sûr de vouloir annuler l’exclusion de ce joueur?');
define('EB_LADDERM_L62', 'Exclure le Joueur');
define('EB_LADDERM_L63', 'Êtes-vous sûr de vouloir exclure ce joueur?');
define('EB_LADDERM_L64', 'Kick le Joueur');
define('EB_LADDERM_L65', 'Êtes-vous sûr de vouloir supprimer ce joueur?');
define('EB_LADDERM_L66', 'Supprimer les Matchs du Joueur');
define('EB_LADDERM_L67', 'Êtes-vous sûr de vouloir supprimer les matchs de ce joueur?');
define('EB_LADDERM_L68', 'Supprimer les Trophés du Joueur');
define('EB_LADDERM_L69', 'Êtes-vous sûr de vouloir supprimer les trophés de ce joueur?');
define('EB_LADDERM_L70', 'Réinitialiser Joueurs/Equipes.');
define('EB_LADDERM_L71', '- Réinitialise les Statistics des Joueurs et des Équipes (Classement, Score, ELO, Skill, Matchs Joués, Victoires, Défaites)<br />- Efface tous les Matchs');
define('EB_LADDERM_L72', 'Réinitialiser les Scores');
define('EB_LADDERM_L73', 'Êtes-vous sûr de vouloir supprimer les Scores de ce tournoi?');
define('EB_LADDERM_L74', 'Réinitialiser le Tournoi.');
define('EB_LADDERM_L75', '- Efface tous les Joueurs et Équipes.<br />- Efface tous les Matchs.');
define('EB_LADDERM_L76', 'Réinitialiser le Tournoi');
define('EB_LADDERM_L77', 'Êtes-vous sûr de vouloir réinitialiser ce tournoi?');
define('EB_LADDERM_L78', 'Efface le Tournoi.');
define('EB_LADDERM_L79', '- Efface le Tournoi.<br />');
define('EB_LADDERM_L80', 'Effacee le Tournoi');
define('EB_LADDERM_L81', 'Êtes-vous sûr de vouloir effacer ce tournoi?');
define('EB_LADDERM_L82', 'Recalculer les statistiques du Tournoi.');
define('EB_LADDERM_L83', '- Réinitialise et recalcule les statistiques des joueurs.<br />');
define('EB_LADDERM_L84', 'Recalculer les statistiques du Tournoi');
define('EB_LADDERM_L85', 'Êtes-vous sûr de vouloir recalculer les statistiques?');
define('EB_LADDERM_L86', 'Entrez les notes maximales pour chaque catégorie de statistique.<br />Les catégories seront affichées dans l’ordre décroissant des notes maximales.<br />Les Catégories dont le  max=0 ne sont pas affichées.<br />');
define('EB_LADDERM_L87', 'Stat');
define('EB_LADDERM_L88', 'Max');
define('EB_LADDERM_L89', 'Info Seulement');
define('EB_LADDERM_L90', 'Nombre de Matchs pour être classé');
define('EB_LADDERM_L91', 'Nombre de Matchs d’Équipe pour être classé');
define('EB_LADDERM_L92', 'ELO');
define('EB_LADDERM_L93', 'Matchs Joués');
define('EB_LADDERM_L94', 'Victoires/Défaites');
define('EB_LADDERM_L95', 'Percentage de Victoires');
define('EB_LADDERM_L96', 'Victoires/Nuls/Défaites');
define('EB_LADDERM_L97', 'Adversaires Uniques');
define('EB_LADDERM_L98', 'ELO Moyen des Adversaires');
define('EB_LADDERM_L99', 'Séries');
define('EB_LADDERM_L100', 'Skill');
define('EB_LADDERM_L101', 'Score');
define('EB_LADDERM_L102', 'Score des Adversaires');
define('EB_LADDERM_L103', 'Différence des Score');
define('EB_LADDERM_L104', 'Points');
define('EB_LADDERM_L105', 'Total Max');
define('EB_LADDERM_L106', 'cache la colonne "Total" si activé');
define('EB_LADDERM_L107', 'Sauver les Statistiques');
define('EB_LADDERM_L108', 'Homologation du Match');
define('EB_LADDERM_L109', 'Seuls les membres de la classe sélectionnée (ou au dessus) et peuvent homologuer les matchs');
define('EB_LADDERM_L110', 'Admin du Tournoi');
define('EB_LADDERM_L111', 'Moderateur du Tournoi');
define('EB_LADDERM_L112', 'Adversaire du Rapporteur du Match');
define('EB_LADDERM_L113', 'Désactiver');
define('EB_LADDERM_L114', 'équipe(s)');
define('EB_LADDERM_L115', 'Pas d’Équipes');
define('EB_LADDERM_L116', 'Par équipe');
define('EB_LADDERM_L117', 'Type de Classement');
define('EB_LADDERM_L118', 'Classique: Players are ranked based on their score in the first stats category, if 2 players are tied, they are ranked based on the second stats category, and so on<br />
Combined Stats: Players are ranked based on a combination of their scores in each stats category');
define('EB_LADDERM_L119', 'Classique');
define('EB_LADDERM_L120', 'Stats combinées');
define('EB_LADDERM_L121', 'Challenges');
define('EB_LADDERM_L122', 'Activer/Désactiver les Challenges');
define('EB_LADDERM_L123', 'Sauver les Paramètres des Challenges');
define('EB_LADDERM_L124', 'Nombre maximum de dates par Challenge');
define('EB_LADDERM_L125', 'Nombre maximum de maps par match');

define('EB_LADDERP_L1', 'Tournois passés');
define('EB_LADDERP_L2', 'Tournois passés');
define('EB_LADDERP_L3', 'Retour vers');
define('EB_LADDERP_L4', 'Tournois');

define('EB_LADDERC_L1', 'Créer un Tournoi');
define('EB_LADDERC_L2', 'Vous n’êtes pas autorisé à créer un tournoi');
define('EB_LADDERC_L3', 'Tournoi');
define('EB_LADDERC_L4', 'Ajoutez la description de ce tournoi ici');
