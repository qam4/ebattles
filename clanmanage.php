...
else
{
	...
	else
	{
		...
		<!-- Clan Website -->
		<tr>
		<td class="forumheader3"><b>'.EB_CLANM_L31.'</b></td>
		<td class="forumheader3">
		...
		<!-- Clan Email -->
		<tr>
		<td class="forumheader3"><b>'.EB_CLANM_L32.'</b></td>
		<td class="forumheader3">
		...
		<!-- Clan IM -->
		<tr>
		<td class="forumheader3"><b>'.EB_CLANM_L33.'</b></td>
		<td class="forumheader3">
		...
		<!-- Clan Description -->
		<tr>
		<td class="forumheader3"><b>'.EB_CLANM_L34.'</b></td>
		<td class="forumheader3">
